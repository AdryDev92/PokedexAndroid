...
public class GetPokedexJSONData extends GetRawData {

    private static final String LOG_TAG = GetPokedexJSONData.class.getSimpleName();

    private List<Photo> mPhotos;
    private Uri mDestinationUri;

    public GetPokedexJSONData(String searchCriteria, boolean matchAll) {
        super(null);
    ...
    private boolean createAndUpdateUri(String searchCriteria, boolean matchAll) {
        final String FLICKR_BASE_API_URL = "https://pokeapi.co/api/v2/pokemon";
